...
const Footer = () => {
  ...
  return (
    <footer className="bg-black/20 backdrop-blur-lg text-white border-t border-white/10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="bg-white/10 hover:bg-white/20 rounded-lg p-3 transition-colors duration-200 backdrop-blur-sm"
              >
        ...
        <div className="py-6 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center text-white/60 text-sm">
              <span>Feito com</span>
              <Heart className="h-4 w-4 text-white mx-1" />
