      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {services.map((service, index) => (
            <div
              key={index}
              className="group bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-lg hover-lift animate-fade-in"
        ...
        {/* Support Section */}
        <div className="bg-gray-50 border border-gray-200 rounded-2xl p-8 lg:p-12 text-center animate-fade-in">
          <div className="flex justify-center mb-6">
            <div className="bg-red-600 rounded-full p-4">
              <Headphones className="h-12 w-12 text-white" />
            </div>
          </div>
          <h3 className="text-3xl font-bold mb-4 text-gray-900">Suporte Técnico Especializado</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-2 border-gray-600 text-gray-600 hover:bg-gray-600 hover:text-white px-8 py-4 rounded-xl font-semibold"
            >
