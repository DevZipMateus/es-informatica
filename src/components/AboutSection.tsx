        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="animate-slide-in">
            ...
            <div className="space-y-6">
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 glass-effect hover-lift">
                <h4 className="text-lg font-semibold text-white mb-3">Nossa Missão</h4>
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 glass-effect hover-lift">
                <h4 className="text-lg font-semibold text-white mb-3">Nossa Visão</h4>
                <p className="text-white/80 leading-relaxed">
          ...
          <div className="animate-fade-in">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 glass-effect">
              <h4 className="text-2xl font-bold mb-6 text-white">Marcos Importantes</h4>
              <div className="space-y-6">
                {milestones.map((milestone, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    <div className="bg-white/20 rounded-lg px-3 py-1 text-sm font-bold min-w-fit text-white">
                      {milestone.year}
                    </div>
                    <div>
                      <h5 className="font-semibold mb-1 text-white">{milestone.title}</h5>
        ...
        <div className="animate-fade-in">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-lg rounded-xl p-6 text-center glass-effect hover-lift">
