        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="animate-slide-in">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 hover-lift">
                <h4 className="text-lg font-semibold text-gray-900 mb-3">Nossa Missão</h4>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 hover-lift">
                <h4 className="text-lg font-semibold text-gray-900 mb-3">Nossa Visão</h4>
                <p className="text-gray-700 leading-relaxed">
          ...
          <div className="animate-fade-in">
            <div className="bg-gray-50 border border-gray-200 rounded-2xl p-8">
              <h4 className="text-2xl font-bold mb-6 text-gray-900">Marcos Importantes</h4>
              <div className="space-y-6">
                {milestones.map((milestone, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    <div className="bg-red-600 text-white rounded-lg px-3 py-1 text-sm font-bold min-w-fit">
                      {milestone.year}
                    </div>
                    <div>
                      <h5 className="font-semibold mb-1 text-gray-900">{milestone.title}</h5>
        ...
        <div className="animate-fade-in">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              <div key={index} className="bg-gray-50 border border-gray-200 rounded-xl p-6 text-center hover-lift">
