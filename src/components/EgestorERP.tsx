    ...
    <section className="py-16 bg-white overflow-hidden">
      <div className="container px-4 mx-auto max-w-6xl">
        ...
        <div className="flex justify-center animate-fade-in">
          ...
          >
            <Button 
              className="w-full py-6 bg-[#7CFFA0] hover:bg-[#6DF090] text-black font-medium rounded-full transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02] text-lg"
              size="lg"
            >
              Teste grátis
            </Button>
